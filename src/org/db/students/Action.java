...
public enum Action {
    ...
    private boolean requireAdditonalData;
    Action(Integer code, boolean requireAdditonalData) {
        this.code = code;
        this.requireAdditonalData = requireAdditonalData;
    }
    ...
    public boolean isRequireAdditonalData() {
        return requireAdditonalData;
    }
